...
public class BetterPerson {
    ...
    // What is this syntax with this (name, age: ...) ?
    // PRO-TIPS: CONSTRUCTOR CHAINING - Calling another constructor from a constructor to avoid code duplication
    public BetterPerson(String name) {
        this(name, 0, null, 0.0, false);
    }

    public BetterPerson(String name, int age, Integer hospitalId, double weight, boolean checkedIn) {
        this.name = name;
        this.age = age;
